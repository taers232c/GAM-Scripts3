#!/usr/bin/env python3
"""
# Purpose: For a Google Drive User(s), show all drive file ACLs for files only shared outside of a list of specified domains
...
#  $ python3 GetSharedOnlyExternallyDriveACLs.py filelistperms.csv deleteperms.csv
