...
#  $ Basic: gam all users print filelist id title permissions owners query "(visibility='anyoneCanFind' or visibility='domainCanFind')" > filelistperms.csv
#  $ Advanced: gam config auto_batch_min 1 redirect csv ./filelistperms.csv multiprocess all users print filelist fields id,name,permissions,owners.emailaddress query "(visibility='anyoneCanFind' or visibility='domainCanFind')"
...
outputCSV = csv.DictWriter(outputFile,
                           ['Owner', 'driveFileId', 'driveFileTitle', 'permissionId', 'role', 'type', 'allowFileDiscovery', 'domain'],
