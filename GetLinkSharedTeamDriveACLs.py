#!/usr/bin/env python3
"""
# Purpose: Get all drive file ACLs for Team Drive files shared with anyone/domain withlink
...
#  $ gam config csv_input_row_filter "organizers:regex:^.+$" redirect csv ./filelistperms.csv multiprocess csv ./TeamDriveOrganizers.csv gam user "~organizers" print filelist select teamdriveid "~id" fields teamdriveid,id,name,permissions,linksharemetadata,resourcekey,mimetype,webviewlink query "(visibility='anyoneWithLink' or visibility='domainWithLink')"
# 6: Go to step 11
